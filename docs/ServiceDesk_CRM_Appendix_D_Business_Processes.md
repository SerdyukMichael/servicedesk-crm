...
| 16 | Проверка акта | Рук. сервиса | Проверить корректность, принять или вернуть | Д-09 (На проверке) | BR-R-004: акт обязателен |
...
| 9 | Обновление паспорта | Система | Обновить last_maintenance_date |
...
| 7 | История оборудования | Нет | Паспорт устройства, история через заявки | Нет данных | БП-02, БП-07 |
